                ...
                <div class="card-body">
                    ...
                    <form action="email-script.php" method="post" class="form-signin">
                        <div class="form-label-group">
                            ...
                            <input type="text" name="fromEmail" id="fromEmail" class="form-control"  placeholder="Masukkan Alamat Email" required autofocus>
                        </div> <br/>
                        <div class="form-label-group">
                            <label for="inputEmail">To <span style="color: #FF0000">*</span></label>
                            <input type="text" name="toEmail" id="toEmail" class="form-control" value="dasalabindonesia@.gmail.com" readonly required autofocus>
                        </div> <br/>
